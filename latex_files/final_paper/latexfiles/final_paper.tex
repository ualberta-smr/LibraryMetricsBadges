...
this method is inefficent and requires many repititous searches or the data can be outdated
...
, and metrics themselves that help developers view inside aspects of a library \cite{analogical,githubbadges,metrics,transparency,shopifyarticle}.
...
Building such a front end application for this is possible and a long term goal. 
