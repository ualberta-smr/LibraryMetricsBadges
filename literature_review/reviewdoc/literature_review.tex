...
Hora et. al \cite{apiwave} dicusses these 2 obstacles and implements a web application \textit{apiwave} to mitigate these problems and
highlight API popularity and migration in depth.
...
based on the most popular software metrics to determine if it will help reccomend and differentiate
