...
% results: badges that display build status, test, coverage, and updated dependendencies are positively correlated with better code practisies.
% assessment signals that are more costly (took more work to produce) are better than conventional low quality badges that display something trivial already found on repo

% weaknesses : survey used had too low of a population and thus is hard to generalize
% to the majority
