...
A weakness is that although the evaluation of the study is optimistic, having 100\% as a metric for using both
would be hard to generalize for a larger population. Giving a hard edge case percentage will be difficult to tell later on for false positive tests.
